...
namespace FondOfSpryker\Client\BrandCustomer\Dependency\Client;

use Spryker\Client\ZedRequest\ZedRequestClientInterface;
use Spryker\Shared\Kernel\Transfer\TransferInterface;

class BrandCustomerToZedRequestClientBridge implements BrandCustomerToZedRequestClientInterface
{
    /**
